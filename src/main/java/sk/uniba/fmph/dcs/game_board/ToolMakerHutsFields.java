...
public class ToolMakerHutsFields {
    ...
    private boolean violatesRestriction() {
        int result = (toolMakerFigures.isEmpty() ? 1 : 0) + (hutFigures.isEmpty() ? 1 : 0) + (fieldsFigures.isEmpty() ? 1 : 0);
     ...
     */
    public String state() {
        Map<String, String> state = Map.of("toolMakerFigures", toolMakerFigures.toString(), "hutFigures", hutFigures.toString(), "fieldsFigures", fieldsFigures.toString());
